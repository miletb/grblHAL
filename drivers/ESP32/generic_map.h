...
#define STEP_MASK       (1ULL << X_STEP_PIN|1ULL << Y_STEP_PIN|1ULL << Z_STEP_PIN|1ULL << A_STEP_PIN) // All step bits
...
#define DIRECTION_MASK      (1ULL << X_DIRECTION_PIN|1ULL << Y_DIRECTION_PIN|1ULL << Z_DIRECTION_PIN|1ULL << A_DIRECTION_PIN) // All direction bits
...
#define SPINDLEPWMPIN           GPIO_NUM_15
...
//#define CONTROL_MASK        (1UL << RESET_PIN)
